...
from from nndet.arch.heads.comb.size_to_weight import boxes_size_weight_combine

class BoxHeadRAComputeBase:
    @staticmethod
...
class BoxHeadRAFocal(BoxHeadAll, BoxHeadRAComputeBase):
    """
    Risk-adjusted (RA) adaptation of BoxHead for Focal loss
    """
    ...
    def compute_loss(self, 
        ...
        ### ---- Calculate "risk"
        risk_pred, risk_target = BoxHeadRAComputeBase.compute_size_weights(
